package org.m9mx.cactus.glowberry.util.scribble.gui.edit;
...
public class RichMultiLineTextField extends MultilineTextField {
    ...
    public boolean keyPressed(KeyEvent event) {
        ...
        boolean keepFormatting = (module != null && module.active()) && module.copyFormattingCodes.get() ^ event.hasShiftDown();
