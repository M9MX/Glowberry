...
import org.m9mx.cactus.glowberry.util.scribble.KeyboardUtil;
import org.m9mx.cactus.glowberry.util.scribble.SetReturnScreen;
...
import org.m9mx.cactus.glowberry.util.scribble.gui.button.ColorSwatchWidget;
import org.m9mx.cactus.glowberry.util.scribble.gui.button.IconButtonWidget;
import org.m9mx.cactus.glowberry.util.scribble.gui.button.ModifierButtonWidget;
import org.m9mx.cactus.glowberry.util.scribble.gui.edit.RichEditBox;
import org.m9mx.cactus.glowberry.util.scribble.gui.edit.RichMultiLineTextField;
import org.m9mx.cactus.glowberry.util.scribble.history.CommandManager;
import org.m9mx.cactus.glowberry.util.scribble.history.HistoryListener;
import org.m9mx.cactus.glowberry.util.scribble.history.command.Command;
import org.m9mx.cactus.glowberry.util.scribble.history.command.EditCommand;
import org.m9mx.cactus.glowberry.util.scribble.history.command.PageDeleteCommand;
import org.m9mx.cactus.glowberry.util.scribble.history.command.PageInsertCommand;
...
public class ScribbleBookEditScreen extends ScribbleBookScreen<RichText> implements HistoryListener {
    ...
    protected boolean shouldShowActionButtons() {
        ...
        return module.showActionButtons.get() != ScribbleModule.ShowActionButtons.NEVER;
    }
    ...
    private void loadFromFile(Path path) {
        try {
            ...
            LOGGER.error("could not load book from file", e);
        }
    }
    ...
    protected void init() {
        ...
        ScribbleModule module = ScribbleModule.INSTANCE;
        if (module != null && module.active() && module.showFormattingButtons.get()) {
