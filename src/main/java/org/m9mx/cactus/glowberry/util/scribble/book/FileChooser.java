...
package org.m9mx.cactus.glowberry.util.scribble.book;
...
public class FileChooser {
    ...
    private static final String BOOK_DIR_NAME = "books";
        ...
        new Thread(() -> {
            try (MemoryStack stack = MemoryStack.stackPush()) {
                ...
                try {
                    ...
                    LOGGER.error("failed to choose path", e);
                }
            }
        }, "File chooser").start();
    }
    ...
    private static Path createAndGetBookDirectory() {
        Path bookDir = Minecraft.getInstance().gameDirectory.toPath().resolve(BOOK_DIR_NAME);
        ...
        try {
            ...
            LOGGER.warn("couldn't create the default book directory");
        }
    ...
    public static void convertLegacyBooks() {
        Path rootDir = createAndGetBookDirectory();
            ...
            Files.walkFileTree(rootDir, new SimpleFileVisitor<>() {
                ...
                public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) {
                    if (file.toString().endsWith(".book")) {
                        LOGGER.info("converting legacy NBT-based book file at {} to JSON.", file);
                        ...
                        try {
                            ...
                            LOGGER.error("failed to convert legacy NBT-based book file at {} to JSON.", file, e);
                        }
