...
import org.m9mx.cactus.glowberry.util.scribble.gui.PageNumberWidget;
...
public abstract class ScribbleBookScreen<T> extends Screen {
    ...
    protected void init() {
        ...
        this.pagesToShow = (module != null && module.active() && module.doublePageViewing.get()) ? 2 : 1;
        
        if (this.pagesToShow == 1) {
            this.backgroundTexture = BookViewScreen.BOOK_LOCATION;
        } else {
            this.backgroundTexture = Identifier.fromNamespaceAndPath("glowberry", "textures/gui/book_" + this.pagesToShow + ".png");
        }
    ...
    private void initSettingsButton(int x, int y) {
        MutableComponent settingsText = Component.literal("Scribble\n")
    ...
    public int getBackgroundY() {
        ScribbleModule module = ScribbleModule.INSTANCE;
        boolean centerBook = (module != null) && module.active() && module.centerBookGui.get();
