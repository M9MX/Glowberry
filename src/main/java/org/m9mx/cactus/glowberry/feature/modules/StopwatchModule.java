...
public class StopwatchModule extends Module {
    ...
    public StopwatchModule(Category category) {
        ...
        this.startPauseKeybind = sgGeneral.add(new KeybindSetting("startPauseStopwatch", KeyBind.of(GLFW.GLFW_KEY_UNKNOWN)));
    ...
    public String formatTime(long millis) {
        ...
        if (showMilliseconds.get()) {
            sb.append("§7.").append("§e").append(String.format("%03d", ms)).append("§7ms");
        }
